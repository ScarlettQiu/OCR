...
if platform.system() == "Windows":
    ...
    pytesseract.pytesseract.tesseract_cmd = (
        r"/opt/homebrew/Cellar/tesseract/5.3.1/bin/tesseract"
    )

    path_to_poppler_exe = r'/opt/homebrew/Cellar/poppler/23.04.0/bin'
    out_directory = Path(r'~/Desktop').expanduser()

# Path of the Input pdf
PDF_file = Path(r"/Users/qiuyu/Desktop/Test-Driving-Snowflake.pdf")
